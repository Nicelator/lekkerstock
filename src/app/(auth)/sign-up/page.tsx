      ...
      >
        ...
        <div>
          ...
          >
            African creativity,
            <br />
            <em style={{ fontStyle: "italic", color: "#c8692e" }}>monetized.</em>
          </h2>
          ...
          {step === 1 ? (
                ...
                {([
                  {
                    ...
                    Icon: ShoppingBag,
                    label: "I'm a Buyer",
                    desc: "License African content for projects, campaigns, and media",
                  },
                  {
                    value: "contributor" as Role,
                    Icon: Camera,
                    label: "I'm a Creator",
                    desc: "Upload and sell my photos, videos, and illustrations",
                  },
            ...
            <>
              <div style={{ marginBottom: "32px" }}>
                ...
                <p style={{ color: "rgba(250,246,239,0.4)", fontSize: "14px", fontFamily: "'Outfit', sans-serif" }}>
                  Joining as a{" "}
                  <span style={{ color: "#c8692e", textTransform: "capitalize" }}>{role}</span>
                </p>
              </div>
